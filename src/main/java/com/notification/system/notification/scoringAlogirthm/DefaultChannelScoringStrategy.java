...
import com.notification.system.notification.reliabilityMetrics.calculate.DynamicReliabilityCalculator;
...
public class DefaultChannelScoringStrategy implements ChannelScoringStrategy{
    ...
    private final DynamicReliabilityCalculator dynamicReliabilityCalculator;
    ...
    public double score(User user,
        ...
        double reliabilityScore= dynamicReliabilityCalculator.score(channel);
